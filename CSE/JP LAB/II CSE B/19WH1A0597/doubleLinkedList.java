...
class linked {
	...
	void delete() {
		...
		System.out.println("Enter the node number which you want to delete from list:");
	...
	void display() {
		...
		System.out.println("\nDisplaying the nodes in double linked list:\n");
		while (node != null) {
			node.display();
			node = node.next;
		}
...
class doubleLinkedList {
	public static void main(String args[]) {
		...
		int op = 0;
		while (op != 5) {
			System.out.println("\nOperations to be performed on the double linked list");
			System.out.println("\n----------------------------------------------------------------\n");
